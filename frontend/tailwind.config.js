    ...
    theme: {
        ...
        extend: {
            ...
            colors: {
                ...
                'slide-bg': 'oklch(var(--slide-bg))',
                'slide-surface': 'oklch(var(--slide-surface))',
                'slide-surface-2': 'oklch(var(--slide-surface-2))',
                gold: 'oklch(var(--gold))',
                'gold-dim': 'oklch(var(--gold-dim))',
                'swipe-right': 'oklch(var(--swipe-right))',
                'swipe-left': 'oklch(var(--swipe-left))',
            },
            borderRadius: {
                lg: 'var(--radius)',
